...
namespace polygon_coverage_planning
{
    ...
    private:
        ...
        tf::TransformBroadcaster broadcaster_map;
        tf::TransformBroadcaster broadcaster_world;

        ros::Subscriber mark_sub_;
        void markObstacleCallback(
            const polygon_coverage_msgs::PolygonWithHolesStamped &msg);

        ros::Subscriber sub_gnss;
        void GnssCallback(const geometry_msgs::PointStamped &gpsposition);
