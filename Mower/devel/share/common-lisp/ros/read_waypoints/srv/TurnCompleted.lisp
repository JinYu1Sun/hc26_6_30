...
(cl:in-package read_waypoints-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <TurnCompleted-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TurnCompleted-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name read_waypoints-srv:<TurnCompleted-request> is deprecated: use read_waypoints-srv:TurnCompleted-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <TurnCompleted-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader read_waypoints-srv:x-val is deprecated.  Use read_waypoints-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <TurnCompleted-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader read_waypoints-srv:y-val is deprecated.  Use read_waypoints-srv:y instead.")
  (y m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TurnCompleted-request>)))
  ...
  "read_waypoints/TurnCompletedRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TurnCompleted-request)))
  "Returns string type for a service object of type 'TurnCompleted-request"
  "read_waypoints/TurnCompletedRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <TurnCompleted-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TurnCompleted-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name read_waypoints-srv:<TurnCompleted-response> is deprecated: use read_waypoints-srv:TurnCompleted-response instead.")))

(cl:ensure-generic-function 'turn_finish-val :lambda-list '(m))
(cl:defmethod turn_finish-val ((m <TurnCompleted-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader read_waypoints-srv:turn_finish-val is deprecated.  Use read_waypoints-srv:turn_finish instead.")
  (turn_finish m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TurnCompleted-response>)))
  ...
  "read_waypoints/TurnCompletedResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TurnCompleted-response)))
  "Returns string type for a service object of type 'TurnCompleted-response"
  "read_waypoints/TurnCompletedResponse")
