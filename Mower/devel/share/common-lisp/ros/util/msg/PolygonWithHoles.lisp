...
(cl:defmethod cl:initialize-instance :after ((m <PolygonWithHoles>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PolygonWithHoles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name util-msg:<PolygonWithHoles> is deprecated: use util-msg:PolygonWithHoles instead.")))

(cl:ensure-generic-function 'hull-val :lambda-list '(m))
(cl:defmethod hull-val ((m <PolygonWithHoles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader util-msg:hull-val is deprecated.  Use util-msg:hull instead.")
  (hull m))

(cl:ensure-generic-function 'holes-val :lambda-list '(m))
(cl:defmethod holes-val ((m <PolygonWithHoles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader util-msg:holes-val is deprecated.  Use util-msg:holes instead.")
  (holes m))
