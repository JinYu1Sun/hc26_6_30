...
(cl:defmethod cl:initialize-instance :after ((m <LocalPath>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LocalPath)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name util-msg:<LocalPath> is deprecated: use util-msg:LocalPath instead.")))
...
(cl:defmethod point_num-val ((m <LocalPath>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader util-msg:point_num-val is deprecated.  Use util-msg:point_num instead.")
  (point_num m))

(cl:ensure-generic-function 'pathtype-val :lambda-list '(m))
(cl:defmethod pathtype-val ((m <LocalPath>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader util-msg:pathtype-val is deprecated.  Use util-msg:pathtype instead.")
  (pathtype m))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <LocalPath>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader util-msg:x-val is deprecated.  Use util-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <LocalPath>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader util-msg:y-val is deprecated.  Use util-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <LocalPath>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader util-msg:speed-val is deprecated.  Use util-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'heading-val :lambda-list '(m))
(cl:defmethod heading-val ((m <LocalPath>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader util-msg:heading-val is deprecated.  Use util-msg:heading instead.")
  (heading m))

(cl:ensure-generic-function 'gear-val :lambda-list '(m))
(cl:defmethod gear-val ((m <LocalPath>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader util-msg:gear-val is deprecated.  Use util-msg:gear instead.")
  (gear m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LocalPath>)))
  ...
  (cl:format cl:nil "Header header~%~%uint8 point_num~%~%uint8 pathtype~%float32[] x~%# m~%~%float32[] y~%# m~%float32[] speed~%# km/h~%~%float32[] heading~%# deg, OX=0, OY=90, 0~~360~%~%int8[] gear~%#0-P档，1-d档，2-R档~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LocalPath)))
  "Returns full string definition for message of type 'LocalPath"
  (cl:format cl:nil "Header header~%~%uint8 point_num~%~%uint8 pathtype~%float32[] x~%# m~%~%float32[] y~%# m~%float32[] speed~%# km/h~%~%float32[] heading~%# deg, OX=0, OY=90, 0~~360~%~%int8[] gear~%#0-P档，1-d档，2-R档~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
