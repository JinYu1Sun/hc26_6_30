...
"""autogenerated by genpy from read_waypoints/LocalPath.msg. Do not edit."""
import codecs
import sys
...
class LocalPath(genpy.Message):
  _md5sum = "9ac50f3bf973dc89bfd9fc11a737e2c4"
  _type = "read_waypoints/LocalPath"
...
string frame_id
"""
  __slots__ = ['header','point_num','x','y','speed','heading','gear']
  _slot_types = ['std_msgs/Header','uint8','float32[]','float32[]','float32[]','float32[]','int8[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,point_num,x,y,speed,heading,gear
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.point_num,) = _get_struct_B().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
