...
message(STATUS "fast_lio: 4 messages, 0 services")

set(MSG_I_FLAGS "-Ifast_lio:/home/nvidia/libo/slam/src/FAST_LIO/msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/nvidia/libo/slam/src/FAST_LIO/msg/Pose6D.msg" NAME_WE)
add_custom_target(_fast_lio_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "fast_lio" "/home/nvidia/libo/slam/src/FAST_LIO/msg/Pose6D.msg" ""
)

get_filename_component(_filename "/home/nvidia/libo/slam/src/FAST_LIO/msg/LIOPose.msg" NAME_WE)
add_custom_target(_fast_lio_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "fast_lio" "/home/nvidia/libo/slam/src/FAST_LIO/msg/LIOPose.msg" "std_msgs/Header"
)

get_filename_component(_filename "/home/nvidia/libo/slam/src/FAST_LIO/msg/GPS.msg" NAME_WE)
add_custom_target(_fast_lio_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "fast_lio" "/home/nvidia/libo/slam/src/FAST_LIO/msg/GPS.msg" "std_msgs/Header"
)

get_filename_component(_filename "/home/nvidia/libo/slam/src/FAST_LIO/msg/Position.msg" NAME_WE)
add_custom_target(_fast_lio_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "fast_lio" "/home/nvidia/libo/slam/src/FAST_LIO/msg/Position.msg" "std_msgs/Header"
)
