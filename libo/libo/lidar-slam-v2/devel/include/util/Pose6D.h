// Generated by gencpp from file util/Pose6D.msg
// DO NOT EDIT!


#ifndef UTIL_MESSAGE_POSE6D_H
#define UTIL_MESSAGE_POSE6D_H
...
struct Pose6D_
{
  ...
  typedef boost::shared_ptr< ::util::Pose6D_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::util::Pose6D_<ContainerAllocator> const> ConstPtr;

}; // struct Pose6D_

typedef ::util::Pose6D_<std::allocator<void> > Pose6D;

typedef boost::shared_ptr< ::util::Pose6D > Pose6DPtr;
typedef boost::shared_ptr< ::util::Pose6D const> Pose6DConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::util::Pose6D_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::util::Pose6D_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::util::Pose6D_<ContainerAllocator1> & lhs, const ::util::Pose6D_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::util::Pose6D_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::util::Pose6D_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::util::Pose6D_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::util::Pose6D_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::util::Pose6D_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::util::Pose6D_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::util::Pose6D_<ContainerAllocator> >
{
  ...
  static const char* value(const ::util::Pose6D_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xab486e9c24704038ULL;
  static const uint64_t static_value2 = 0x320abf9ff59003d2ULL;
};

template<class ContainerAllocator>
struct DataType< ::util::Pose6D_<ContainerAllocator> >
{
  static const char* value()
  {
    return "util/Pose6D";
...
template<class ContainerAllocator>
struct Definition< ::util::Pose6D_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::util::Pose6D_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::util::Pose6D_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::util::Pose6D_<ContainerAllocator>& v)
  {
