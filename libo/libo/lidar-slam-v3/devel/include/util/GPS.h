// Generated by gencpp from file util/GPS.msg
// DO NOT EDIT!


#ifndef UTIL_MESSAGE_GPS_H
#define UTIL_MESSAGE_GPS_H
...
struct GPS_
{
  ...
  typedef boost::shared_ptr< ::util::GPS_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::util::GPS_<ContainerAllocator> const> ConstPtr;

}; // struct GPS_

typedef ::util::GPS_<std::allocator<void> > GPS;

typedef boost::shared_ptr< ::util::GPS > GPSPtr;
typedef boost::shared_ptr< ::util::GPS const> GPSConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::util::GPS_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::util::GPS_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::util::GPS_<ContainerAllocator1> & lhs, const ::util::GPS_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::util::GPS_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::util::GPS_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::util::GPS_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::util::GPS_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::util::GPS_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::util::GPS_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::util::GPS_<ContainerAllocator> >
{
  ...
  static const char* value(const ::util::GPS_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xf75c3f5644c5aad5ULL;
  static const uint64_t static_value2 = 0xa6320ced80a0264cULL;
};

template<class ContainerAllocator>
struct DataType< ::util::GPS_<ContainerAllocator> >
{
  static const char* value()
  {
    return "util/GPS";
...
template<class ContainerAllocator>
struct Definition< ::util::GPS_<ContainerAllocator> >
{
  static const char* value()
  {
    return "#GpsPosition\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::util::GPS_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::util::GPS_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::util::GPS_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
