...
(cl:defmethod cl:initialize-instance :after ((m <Point2D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Point2D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name obstacle_avoidance-msg:<Point2D> is deprecated: use obstacle_avoidance-msg:Point2D instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Point2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_avoidance-msg:x-val is deprecated.  Use obstacle_avoidance-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Point2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_avoidance-msg:y-val is deprecated.  Use obstacle_avoidance-msg:y instead.")
  (y m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Point2D>)))
  ...
  (cl:format cl:nil "# Point2D.msg~%float32 x~%float32 y~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Point2D)))
  "Returns full string definition for message of type 'Point2D"
  (cl:format cl:nil "# Point2D.msg~%float32 x~%float32 y~%~%~%"))
