...
(cl:defmethod cl:initialize-instance :after ((m <Intervene-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Intervene-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name util-srv:<Intervene-request> is deprecated: use util-srv:Intervene-request instead.")))

(cl:ensure-generic-function 'node_id-val :lambda-list '(m))
(cl:defmethod node_id-val ((m <Intervene-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader util-srv:node_id-val is deprecated.  Use util-srv:node_id instead.")
  (node_id m))

(cl:ensure-generic-function 'node_status-val :lambda-list '(m))
(cl:defmethod node_status-val ((m <Intervene-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader util-srv:node_status-val is deprecated.  Use util-srv:node_status instead.")
  (node_status m))

(cl:ensure-generic-function 'msg-val :lambda-list '(m))
(cl:defmethod msg-val ((m <Intervene-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader util-srv:msg-val is deprecated.  Use util-srv:msg instead.")
  (msg m))
...
(cl:defmethod cl:initialize-instance :after ((m <Intervene-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Intervene-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name util-srv:<Intervene-response> is deprecated: use util-srv:Intervene-response instead.")))

(cl:ensure-generic-function 'node_event-val :lambda-list '(m))
(cl:defmethod node_event-val ((m <Intervene-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader util-srv:node_event-val is deprecated.  Use util-srv:node_event instead.")
  (node_event m))
