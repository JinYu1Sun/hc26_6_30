...
"""autogenerated by genpy from util/DiagnosticResult.msg. Do not edit."""
import codecs
import sys
...
class DiagnosticResult(genpy.Message):
  _md5sum = "d380b94db25b373da53086abf486f7d3"
  _type = "util/DiagnosticResult"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DiagnosticResult, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.fault_code,) = _get_struct_B().unpack(str[start:end])
      return self
