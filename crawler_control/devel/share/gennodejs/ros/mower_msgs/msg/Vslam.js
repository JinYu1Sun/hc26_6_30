...
class Vslam {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('local_z')) {
        this.local_z = initObj.local_z
      }
      else {
        this.local_z = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [local_z]
    bufferOffset = _serializer.float64(obj.local_z, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [local_z]
    data.local_z = _deserializer.float64(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.local_z !== undefined) {
      resolved.local_z = msg.local_z;
    }
    else {
      resolved.local_z = 0.0
    }
